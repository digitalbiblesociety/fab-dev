		...
		<div class="mx-auto max-w-7xl px-2 sm:px-4 lg:px-8">
			<div class="relative flex h-16 items-center justify-between">
				<div class="flex items-center px-2 lg:px-0">
					<a href="/{$locale}/" sveltekit:prefetch class="inline-flex items-center shrink-0">
									...
									<Menu>
										<div slot="trigger">
											<div
												...
												{p.t}
												<Icon name="chevron" direction="s" class="inline-block h-4 w-4 text-white transition duration-150 ease-in-out group-hover:text-gray-500" />
											</div>
										</div>
										<div slot="menu">
											<div
												...
												<div
													...
													{#if p.floor}
														<div class="bg-gray-50 p-5 dark:bg-gray-900 sm:p-8">
															<a
																href="{p.floor.href}"
																class="-m-3 flow-root rounded-md p-3 transition duration-150 ease-in-out hover:bg-gray-900 cursor-pointer">
